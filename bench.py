...
def main():
    ...
    sub_avg_throughput: float = float(opts.sub_count) / float(sub_mean_duration)
...
================================================================================
Avg. subscriber duration: %s seconds
Subscriber duration std dev: %s seconds
Avg. Client Throughput: %s p/s
Total Throughput (msg_count * clients) / (avg. sub time): %s p/s
================================================================================
Publisher Results
================================================================================
Avg. publisher duration: %s seconds
Publisher duration std dev: %s seconds
Avg. Client Throughput: %s p/s
Total Throughput (msg_count * clients) / (avg. sub time): %s p/s
"""
    print(output % (
